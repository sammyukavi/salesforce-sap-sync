...
public class SyncDataService extends BaseDataService<Response, SyncRestService> {
	...
	public void getFromSalesforce(GetCallback<Response> callback) {
		executeSingleTask(callback, restService.fetch(getToken()));
	}
	...
	public void pushProductsChildrenToSalesforce(Response productsChildren, GetCallback<Response> callback) {
		executeSingleTask(callback, restService.post(getToken(), PRODUCTS_CHILDREN, productsChildren));
	}
