...
public class ProductChildDbService extends BaseDbDataService<ProductChild> {
	
	@Override
	protected Class<ProductChild> getDaoServiceClass() {
		return ProductChild.class;
	}
	
	public void upsertRecords(ArrayList<ProductChild> products, GetCallback<ArrayList<ProductChild>> callback) {
